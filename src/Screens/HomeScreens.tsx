...
// ─── Main screen ────────────────────────────────────────────────────────────
export default function HomeScreen({ onNavigateToCollection }: HomeScreenProps) {
...
const styles = StyleSheet.create({
  ...
  header: {
    height: 60, borderBottomWidth: StyleSheet.hairlineWidth,
    borderBottomColor: '#DDE3D8', flexDirection: 'row', alignItems: 'center',
    justifyContent: 'space-between', paddingHorizontal: 22, backgroundColor: '#F6F9F2',
  },
  logoRow: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  logoText: {
    fontSize: 22, fontStyle: 'italic', color: '#065F46',
    fontFamily: Platform.select({ ios: 'Georgia', android: 'serif' }), letterSpacing: 0.3,
  },
  settingsBtn: {
    width: 36, height: 36, borderRadius: 18, backgroundColor: '#EEF1EC',
  ...
  subtitle: { fontSize: 16, textAlign: 'center', color: '#6B7368', lineHeight: 24 },
  ...
  micOuterBorder: {
    borderWidth: 1.5, borderColor: 'rgba(242,201,76,0.28)', borderRadius: 999, padding: 14,
  },
  micButton: {
    width: 164, height: 164, borderRadius: 82, backgroundColor: '#F2C94C',
    borderWidth: 7, borderColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center',
    shadowColor: '#F2C94C', shadowOpacity: 0.28, shadowRadius: 18,
  ...
  locationBox: {
    ...
    borderWidth: StyleSheet.hairlineWidth, borderColor: '#D4D9D0', gap: 7,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 6,
    shadowOffset: { width: 0, height: 2 }, elevation: 2,
  },
  locationText: { fontSize: 13, fontWeight: '600', color: '#3A4039', letterSpacing: 0.3 },
  bottomTab: {
    height: 82, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#DDE3D8',
    backgroundColor: 'rgba(246,249,242,0.97)', flexDirection: 'row',
